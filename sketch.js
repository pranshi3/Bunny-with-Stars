...
var grayStar1,oneStar,twoStar,starSprite
var balloon2
...
grayStar=loadAnimation('empty.png')
...
function setup() 
{
  ...
  star1=createSprite(50,340)
  star1.scale=0.02
  star1.addImage(starImage)

  star2=createSprite(310,50)
  star2.scale=0.02
  star2.addImage(starImage)

  starSprite=createSprite(60,30)
  starSprite.addAnimation('empty',grayStar)
starSprite.addAnimation('one',oneStar)
starSprite.addAnimation('two',twoStar)
starSprite.scale=0.2
  
balloon=createImg('baloon2.png')
balloon.position(260,340)
balloon.size(100,120)
...
function draw() 
{
  ...
  if (collide(fruit,star1,20)==true && star2.visible==true){
    star1.visible=false
    starSprite.changeAnimation('one')

  }

  if (collide(fruit,star2,20)==true && star1.visible==false ){
    star2.visible=false
    starSprite.changeAnimation('two')
  }

  if (collide(fruit,star1,20)==true&& star2.visible==false){
    star1.visible=false
    starSprite.changeAnimation('two')
  }
